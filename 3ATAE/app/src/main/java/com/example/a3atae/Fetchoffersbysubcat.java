...
public class Fetchoffersbysubcat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url="http://"+GlobalVariables.ip+"/PfeUsingLaravel8/public/api/getOffersBySubCatId/"+catid;
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if(IL.size()==0){
                                    Intent emptyrecyclerintent=new Intent(getApplicationContext(),noitemsforthissubcat.class);
